...
export default class extends BaseModal {
  ...
  confirmClose() {
    ...
    delete prevData.availability;
    delete prevData.peerID;
    delete prevData.profile;
    ...
    if (save) {
      ...
      save.always(() => this.$saveButton.removeClass('disabled'))
        .fail((...args) => {
          ...
          this.searchData.profile.name = app.profile.get('name');
          this.searchData.item.description = this.$("#editListingDescription").text();
          // 1 represents online status
          // 0 represents offline status1
          this.searchData.availability = 1;
  ...
  setModelData() {
    ...
    this.model.set({
      ...
      item: {
        ...
        categories: [],
        price: formData.item.price !== '' ? formData.item.price : 0,
      },
    });
