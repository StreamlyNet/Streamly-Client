...
export default class extends BaseModal {
  ...
  callNow() {
    // Calling the remote peer and passing: his peerID and listing's title,
    // from where the call was initiated
    app.io.callPeer(this.vendor.peerID, this.model.toJSON().item.title, this.vendor.name, this.vendor.avatar);
  }
  ...
  render() {
    ...
    loadTemplate('modals/listingDetail/listing.html', t => {
      this.$el.html(t({
        ...
        currentUserPid: app.serverConfig.peerID,
      }));
